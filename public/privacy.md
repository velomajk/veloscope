...
This Privacy Policy describes how **Veloscope** (“the App”, “we”, “us”) handles data when used as an app for **Atlassian Jira Cloud**.
...
The App follows Atlassian’s security model and accesses Jira data only via officially supported APIs and permission scopes.

---

## 7. User Rights

Since Veloscope does not store or process personal data, no personal data is subject to access, correction, or deletion requests.

---

## 8. Changes to This Policy

We may update this Privacy Policy if the App’s functionality or data practices change.  
