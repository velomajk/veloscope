...
The KPI cards and KUP % update to use your **effective base** immediately.

> [!warning] Adjustments are locked once your month is approved — ask your manager to un-approve if you need to change them.
